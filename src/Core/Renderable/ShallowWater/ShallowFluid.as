package Core.Renderable.ShallowWater
{
	...
	*/
	public class ShallowFluid
	{
		...
		[Embed("/../bin-debug/embeds/pb/WaveDisplacement.pbj", mimeType="application/octet-stream")]
		private var DisplacementShaderClass:Class;
		private var _displacementShader:Shader;
		
		[Embed("/../bin-debug/embeds/pb/WaveNormals.pbj", mimeType="application/octet-stream")]
		private var NormalsShaderClass:Class;
		private var _normalsShader:Shader;
		
		[Embed("/../bin-debug/embeds/pb/WaveTangents.pbj", mimeType="application/octet-stream")]
